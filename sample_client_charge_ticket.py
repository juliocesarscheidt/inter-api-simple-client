...
def get_argument_parser():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Ticket due date",
    )
    parser.add_argument(
        "--expirationdays",
        type=int,
        required=True,
        help="Ticket expiration days",
    )
    # payer fields
    parser.add_argument(
        "--payercpfcnpj",
        type=str,
        required=True,
        help="Ticket payer CPF or CNPJ",
    )
    parser.add_argument(
        "--payertype",
        type=str,
        required=True,
        help="Ticket payer type",
    )
    parser.add_argument(
        "--payername",
        type=str,
        required=True,
        help="Ticket payer name",
    )
    parser.add_argument(
        "--payeraddress",
        type=str,
        required=True,
        help="Ticket payer address",
    )
    parser.add_argument(
        "--payercity",
        type=str,
        required=True,
        help="Ticket payer city",
    )
    parser.add_argument(
        "--payeruf",
        type=str,
        required=True,
        help="Ticket payer UF",
    )
    parser.add_argument(
        "--payercep",
        type=str,
        required=True,
        help="Ticket payer CEP",
    )
...
if __name__ in "__main__":
    ...
    charge = interClient.send_charge(
        ticket_number, args.amount, args.duedate, args.expirationdays, payer
    )
    print(charge)
    # {'codigoSolicitacao': ''}
