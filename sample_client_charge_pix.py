...
def get_argument_parser():
    ...
    parser.add_argument(
        "--debtorname", type=str, required=False, help="PIX debtor name", default=None
    )
    parser.add_argument(
        "--debtorcnpj", type=str, required=False, help="PIX debtor cnpj", default=None
    )
    parser.add_argument(
        "--debtorcpf", type=str, required=False, help="PIX debtor cpf", default=None
    )
...
if __name__ in "__main__":
    ...
    pix_charge = interClient.send_pix_charge(
        args.receiverkey, args.amount, args.description, debtor
    )
    print(pix_charge)
